...
- **Own bytes only.** A broken **Thumbnail** _designation_ (ADR-0066) is the designated Asset's story, not the designating Entity's; that row degrades to the type icon as before.
