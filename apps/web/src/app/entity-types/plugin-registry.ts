 ...
 * resolved **Structured Field** data-type set, the Type/View → owning-Plugin maps, and the enablement
...
export class PluginRegistry {
  ...
  /** The Structured Field data-types this build carries, one resolved set threaded into the domain (ADR-0050). */
