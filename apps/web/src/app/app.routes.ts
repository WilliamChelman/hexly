...
export const appRoutes: Route[] = [
  ...
  },
  {
    ...
    // resets implicitly (#70). EntityNameResolver shares one owner-list fetch across
    // the `@` picker and every entityLink node view; route-scoped so navigating to
    // another Entity re-resolves names against a fresh list (ADR-0023).
