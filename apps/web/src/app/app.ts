...
@Component({
  ...
  template: `
    ...
    <!--
      The Command Palette (ADR-0032): a Cmd/Ctrl+K overlay mounted once, always
      rendered — reachable from any route. Its Create Commands open the sibling
      create dialog via a shared launcher.
    -->
    <app-command-palette />
