...
/**
 * Which plugins this build bundles, web side (ADR-0048, #192) — the twin of the API's own list.
 * "Bundled" means compiled-in (the ADR rules out runtime third-party plugins), so a plugin joins by
 * shipping a lib and being named here; the registries never learn a plugin's name.
 *
