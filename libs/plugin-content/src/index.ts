 ...
 * visit, entity-link, extract-text, extract-outline), the `core.rich-content` data-type and its
 * canonical {@link CONTENT_FIELD}, and `core.note`. The Angular half — the editor, the slash menu, the
