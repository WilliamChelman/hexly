 ...
 * and the pack-removal confirm (ADR-0080, #414) is built on it. Polyfill the gap once
 * so dialog-driven components are testable; real browsers and the e2e suite use the
