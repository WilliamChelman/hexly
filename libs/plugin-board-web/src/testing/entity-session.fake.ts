...
/**
 * The surface is an EntityDocument value at the `core.field.surface` Field (ADR-0050/0051); it lives in the
...
export class FakeEntitySession extends BaseFakeEntitySession {
  ...
  /**
   * Test helper: adopt whatever sits at the `core.field.surface` key, well-formed or not — a document at rest
...
/**
 * Providers for a spec that injects the route-scoped {@link BoardStore}, over `core.type.board`'s own
