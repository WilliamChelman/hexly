...
/**
 * The collaboration & sharing scope (ADR-0049): owners, grants, members, public links and the
 * shared Entity picker. Registered eagerly — these controls translate imperatively for toasts,
