...
const DECLARATIONS = [
  ...
  { name: '--text-2xs', tier: 'role', type: 'length', public: false, initial: '0.6875rem' },
  { name: '--text-xs', tier: 'role', type: 'length', public: false, initial: '0.75rem' },
  { name: '--text-sm', tier: 'role', type: 'length', public: false, initial: '0.8125rem' },
  { name: '--text-base', tier: 'role', type: 'length', public: false, initial: '0.9375rem' },
  { name: '--text-md', tier: 'role', type: 'length', public: false, initial: '1.0625rem' },
  { name: '--text-lg', tier: 'role', type: 'length', public: false, initial: '1.3125rem' },
  { name: '--text-xl', tier: 'role', type: 'length', public: false, initial: '1.625rem' },
  { name: '--text-2xl', tier: 'role', type: 'length', public: false, initial: '2.0625rem' },
  { name: '--text-3xl', tier: 'role', type: 'length', public: false, initial: '2.5625rem' },
