 ...
 * is edited with the very same {@link ContentEditorComponent} — so formatting, the slash menu, and
 * inline **Entity Links** behave identically (CONTEXT.md → Text Block) — and shown, when static, by the
 * read-only {@link ContentDisplayComponent}.
 *
...
export { ContentDisplayComponent } from './components/content-display.component';
