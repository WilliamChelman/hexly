...
import { PLUGIN_ID, CORE_NOTE_TYPE, CONTENT_FIELD } from '@hexly/plugin-content';
// The vault data-type and its ~160 kB Markdown converter live in this server project, so the toolchain
// loads only through `/server` — never the framework-free base barrel or `/web` (ADR-0051, ADR-0053).
